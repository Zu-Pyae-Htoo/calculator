...
<section class=" bg-gray-200 p-10 rounded-lg">
    ...
    <form action="./exchange-process.php" method="post">
        <div class=" flex justify-between items-center gap-5">
            ...
            <!-- end from -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512 " class="h-5 w-5" stroke="none"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
        ...
        <div class="mb-3 mt-3 flex justify-center items-center gap-3">
            <label for="width" class="block  text-sm font-medium mb-2 dark:text-white">Amount</label>
            <input type="number" name="home_width" id="width" class="py-3 px-4 block border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
        </div>

        <div class=" flex justify-between items-center gap-3 mt-6">
            <button type="submit" name="cal_btn" class="w-2/3 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                Calculate
            </button>
            <button type="submit" name="cal_btn" class="w-1/3 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border-2 border-blue-600 border-transparent text-blue-500  hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                Record List
            </button>
        </div>
    </form>
