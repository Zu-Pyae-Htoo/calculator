...
<section class=" bg-gray-200 p-10 rounded-lg">
    <div class="mb-3">
        <ol class="flex items-center whitespace-nowrap" aria-label="Breadcrumb">
            ...
            <li class="inline-flex items-center">
                <a class="flex items-center text-sm font-semibold text-gray-700 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500"
                    href="#">
                    Exchange Calculator
                    <svg class="flex-shrink-0 mx-2 overflow-visible h-4 w-4 text-gray-400 dark:text-neutral-600"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    <form action="./exchange-process.php" method="post">
        <div class=" grid grid-cols-2 gap-5">
            <div class=" col-span-full">
                <label for="amount" class="block text-sm font-medium mb-2 dark:text-white">Ammount</label>
            ...
            <button type="submit"
                class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 col-span-full">
                Calculate
            </button>
        </div>
