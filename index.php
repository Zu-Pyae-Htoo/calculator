...
<section class=" bg-gray-200 p-10 rounded-lg">
    <div class="mb-3">
        <ol class="flex items-center whitespace-nowrap" aria-label="Breadcrumb">
            ...
            <li class="inline-flex items-center">
                <a class=" font-semibold flex items-center text-sm text-gray-700 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500"
                    href="#">
                    Area Calculator
                    <svg class="flex-shrink-0 mx-2 overflow-visible h-4 w-4 text-gray-400 dark:text-neutral-600"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    <form action="">
        <div class="mb-3">
            ...
            <input type="number" name="home_width" id="width"
        ...
        <div class="mb-5">
            ...
            <input type="number" name="home_breadth" id="breadth"
                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
        </div>

        <button type="submit" name="cal_btn"
